    ...
    <div style={{ padding: '0 24px 24px' }}>
      ...
      <Card>
        <Tabs activeKey={activeTab} onChange={setActiveTab}>
          ...
          >
            <Row gutter={[16, 16]}>
                ...
                >
                  <Descriptions column={1} bordered size="small">
                    ...
                    <Descriptions.Item label="Grupo Sanguíneo">
                      {paciente.tipo_sangre} {paciente.factor_rh}
                    </Descriptions.Item>
                    {paciente.direccion && (
              ...
              <Col xs={24} md={12}>
                ...
                >
                  <Descriptions column={1} bordered size="small">
                    <Descriptions.Item label="Gesta Actual">
                      <Tag color="geekblue">G{embarazo.numero_gesta}</Tag>
                    </Descriptions.Item>
                    ...
                    <Descriptions.Item label="Riesgo">
                      <Tag
                        color={
                          embarazo.riesgo_embarazo === 'alto'
                            ? 'red'
                            : embarazo.riesgo_embarazo === 'medio'
                              ? 'orange'
                              : 'green'
                        }
                      >
            ...
            <Row gutter={[16, 16]}>
              <Col xs={24} md={8}>
                <Card size="small">
                  ...
                  <div style={{ marginTop: 8 }}>
                    <Text type="secondary">IMC: </Text>
                    <Tag color={clasificacionIMC.color}>
                      {imcMaterno?.toFixed(2)} ({clasificacionIMC.texto})
                    </Tag>
                  </div>
                </Card>
              </Col>
              ...
              <Col xs={24} md={8}>
                <Card size="small">
                  <Statistic
                    title="Temperatura"
                    value={control.temperatura ?? 0}
                    suffix="°C"
                    valueStyle={{
                      color: (control.temperatura || 0) >= 38 ? '#cf1322' : '#3f8600',
                    }}
                  />
                </Card>
              </Col>
          ...
          {/* ========== TAB 2: EXAMEN OBSTÉTRICO ========== */}
          <TabPane
            tab={tabExamenObstetrico}
            key="2"
          >
            <Descriptions bordered column={{ xxl: 2, xl: 2, lg: 2, md: 1, sm: 1, xs: 1 }}>
              <Descriptions.Item label="Altura Uterina">
                <Text strong>{control.altura_uterina} cm</Text>
              </Descriptions.Item>
              <Descriptions.Item label="Frecuencia Cardíaca Fetal">
                <Text strong style={{ color: isFCFAnormal ? '#cf1322' : 'inherit' }}>
                  {control.frecuencia_cardiaca_fetal} lpm
                </Text>
              </Descriptions.Item>
              <Descriptions.Item label="Presentación Fetal">
                <Tag color="blue">{control.presentacion_fetal?.toUpperCase()}</Tag>
              </Descriptions.Item>
              <Descriptions.Item label="Movimientos Fetales">
                <Tag
                  color={
                    control.movimientos_fetales === 'ausentes'
                      ? 'red'
                      : control.movimientos_fetales === 'disminuidos'
                        ? 'orange'
                        : 'green'
                  }
                >
                  {control.movimientos_fetales?.toUpperCase()}
                </Tag>
              </Descriptions.Item>
              <Descriptions.Item label="Edema">
                <Tag
                  color={
                    control.edema === 'severo' || control.edema === 'generalizado'
                      ? 'red'
                      : control.edema === 'no'
                        ? 'green'
                        : 'orange'
                ...
                >
                  {control.edema?.toUpperCase()}
                </Tag>
              </Descriptions.Item>
              <Descriptions.Item label="Proteinuria">
                <Tag
                  color={
                    control.proteinuria === 'negativa'
                      ? 'green'
                      : control.proteinuria === 'trazas'
                        ? 'orange'
                        : 'red'
                  }
                >
                  {control.proteinuria?.toUpperCase()}
                </Tag>
              </Descriptions.Item>
            </Descriptions>
            ...
            <Card style={{ backgroundColor: '#f9f9f9' }}>
              <Paragraph>
                {control.observaciones || <Text type="secondary">Sin observaciones registradas.</Text>}
              </Paragraph>
            </Card>
          </TabPane>
          ...
          >
            {hayControlAnterior ? (
              <Table
                dataSource={comparacionConAnterior}
