...
import { computarAlertasEdadGestacional, computarRecomendacionesPorTrimestre } from './partoUtils';
...
const FormularioParto: React.FC = () => {
  ...
  const calcularAlertasYRecomendaciones = useCallback((edadGestacional: string) => {
    ...
    setAlertas(computarAlertasEdadGestacional(semanas, dias));
    setRecomendaciones(computarRecomendacionesPorTrimestre(semanas));
