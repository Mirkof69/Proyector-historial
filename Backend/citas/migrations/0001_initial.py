...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "hora_fin",
                    models.TimeField(
                        help_text="Hora de fin de atención", verbose_name="Hora de Fin",
                    ),
                ),
                (
                    "duracion_cita",
        ...
        migrations.AddIndex(
            model_name="cita",
            index=models.Index(
                fields=["paciente", "-fecha_cita"], name="citas_pacient_382ff4_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="cita",
            index=models.Index(
                fields=["medico", "fecha_cita"], name="citas_medico__be679f_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="cita",
        ...
        migrations.AddIndex(
            model_name="cita",
            index=models.Index(
                fields=["fecha_cita", "hora_cita"], name="citas_fecha_c_2198af_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="disponibilidad",
            index=models.Index(
                fields=["medico", "dia_semana"], name="disponibili_medico__389f2e_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="disponibilidad",
