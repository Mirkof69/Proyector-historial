    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        ...
                        max_digits=5,
                        validators=[
                            django.core.validators.MinValueValidator(Decimal("130.0")),
                            django.core.validators.MaxValueValidator(Decimal("200.0")),
                        ],
                ...
                (
                    ...
                    models.DecimalField(
                        ...
                        null=True,
                        validators=[
                            django.core.validators.MinValueValidator(Decimal("35.0")),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["embarazo_id", "-fecha_control"],
                        name="controles_p_embaraz_cd1232_idx",
                    ),
                    models.Index(
                        fields=["paciente", "-fecha_control"],
                        name="controles_p_pacient_272e28_idx",
                    ),
                    models.Index(
                        fields=["fecha_control"], name="controles_p_fecha_c_713b92_idx",
                    ),
                    models.Index(
                        fields=["-fecha_registro"],
                        name="controles_p_fecha_r_273aa5_idx",
                    ),
                ],
            },
        ),
