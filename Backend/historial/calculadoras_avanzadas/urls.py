...
router.register(r'riesgo-preeclampsia', views.RiesgoPreeclampsiaViewSet, basename='riesgo-preeclampsia')
router.register(r'crecimiento-fetal', views.CrecimientoFetalViewSet, basename='crecimiento-fetal')
router.register(r'riesgo-cromosomico', views.RiesgoCromosomicoViewSet, basename='riesgo-cromosomico')
router.register(r'dosis-medicamentos', views.DosisMedicamentosViewSet, basename='dosis-medicamentos')
router.register(r'hemorragia-obstetrica', views.HemorragiaObstetricaViewSet, basename='hemorragia-obstetrica')
router.register(r'sufrimiento-fetal', views.SufrimientoFetalViewSet, basename='sufrimiento-fetal')
...
urlpatterns = [
    ...
    path('api/riesgo-cromosomico/estadisticas/', 
