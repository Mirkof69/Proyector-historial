...
module.exports = {
  ...
  // Importante: usar clase 'dark' en <html> para modo oscuro
  darkMode: 'class',

  theme: {
    extend: {
      // ============================================================
      // COLORES - SINCRONIZADOS CON ANT DESIGN
      // ============================================================
      colors: {
        // Primario (azul)
        primary: {
          ...
          300: '#93c5fd',
          400: '#60a5fa',
          500: '#3b82f6',  // Ant Design primary dark
          600: '#2563eb',  // Ant Design primary light
          700: '#1d4ed8',
          800: '#1e40af',
          900: '#1e3a8a',
          950: '#172554',
        ...
        // Neutral/Gray - Paleta profesional tipo Vercel/Linear
        neutral: {
          50: '#fafafa',
          100: '#f5f5f5',
          150: '#f3f4f6',
  ...
  plugins: [
    require('@tailwindcss/forms')({
      strategy: 'class', // Solo aplicar estilos cuando se use la clase 'form-input', etc.
    }),
