    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["codigo"], name="tipos_exame_codigo_d29ee8_idx",
                    ),
                    models.Index(
                        fields=["categoria"], name="tipos_exame_categor_18f6bd_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fecha_muestra",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Fecha de Toma de Muestra",
                    ),
                ),
                (
                    "fecha_resultado",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Fecha de Resultado",
                    ),
                ),
                (
                    "estado",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="resultados",
                        to="laboratorio.valorreferencia",
                        verbose_name="Parámetro",
                    ),
                ),
            ],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["paciente", "-fecha_solicitud"],
                name="examenes_la_pacient_3bcedb_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="examenlaboratorio",
        ...
        migrations.AddIndex(
            model_name="examenlaboratorio",
            index=models.Index(
                fields=["-fecha_solicitud"], name="examenes_la_fecha_s_10de24_idx",
            ),
        ),
