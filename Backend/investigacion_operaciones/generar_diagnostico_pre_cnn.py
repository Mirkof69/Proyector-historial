"""
Genera el Jupyter Notebook de Diagnostico Pre-CNN.
Ejecutar: python generar_diagnostico_pre_cnn.py
"""
import json
import os

OUTPUT = os.path.join(os.path.dirname(__file__), "resultados", "Diagnostico_Pre_CNN.ipynb")
...
cells.append(md(
    ...
    "Este notebook verifica que **TODO** esta en orden antes de entrenar EfficientNet-B4 "
    "en la GPU RTX 4070.\n\n",
    "| Check | Categoria |\n",
    "|-------|-----------|\n",
...
# ── CHECK 7: GPU BENCHMARK ────────────────────────────────────────────────────
cells.append(md(
    "---\n## Check 7 — Benchmark GPU RTX 4070 vs CPU (GFLOPS Reales)\n\n",
    "Mide rendimiento real de la GPU en operaciones matriciales y simula "
    "la velocidad de inferencia CNN (imagenes/segundo a 384×384).\n",
))
cells.append(code(
...
# ── CHECK 10: GRAFICOS ESTADO + MONITOREO ENTRENAMIENTO ──────────────────────
cells.append(md(
    "---\n## Check 10 — Graficos de Estado del Sistema y Monitoreo de Entrenamiento\n\n",
    "Muestra el estado general del sistema y las curvas de entrenamiento CNN "
    "leidas desde `training_complete.log` en tiempo real.\n",
))
cells.append(code(
    "try:\n",
    "    import matplotlib\n",
...
cells.append(md(
    ...
    "Lee `training_complete.log` y grafica las curvas de perdida, sensibilidad "
    "y AUC-ROC por epoca. Si el entrenamiento esta en progreso, muestra el "
    "avance actual con porcentajes.\n",
))
cells.append(code(
...
print("Ejecutar en Jupyter: Diagnostico_Pre_CNN.ipynb")
